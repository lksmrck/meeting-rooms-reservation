...
/*     const test1 = [{room: 1, blocks: [1,2,3], date: "21.11.2022"}, {room: 3, blocks: [3,4,5], date: "21.11.2022"}] */
  ...
  /*   const FBmeetings = [
    ...
    const blocksToTime =  [{ block: 1, start: "7:00", end: "7:30"}, 
    { block: 2, start: "7:30", end: "8:00"},
    { block: 3, start: "8:00", end: "8:30"},
    { block: 4, start: "8:30", end: "9:00"},
    { block: 5, start: "9:00", end: "9:30"},
    { block: 6, start: "9:30", end: "10:00"},
    { block: 7, start: "10:00", end: "10:30"},
    { block: 8, start: "10:30", end: "11:00"},
    { block: 9, start: "11:00", end: "11:30"},
    { block: 10, start: "11:30", end: "12:00"},
    { block: 11, time: "12:00 - 12:30", reserved: false},
    { block: 12, time: "12:30 - 13:00", reserved: false},
    { block: 13, time: "13:00 - 13:30", reserved: false},
    { block: 14, time: "13:30 - 14:00", reserved: false},
