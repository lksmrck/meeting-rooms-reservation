...
const Steps = forwardRef<HTMLDivElement>((props, ref) => {
  ...
  return (
    <div
      className=" flex justify-center bg-cover bg-center bg-no-repeat bg-stepsWaves items-center w-screen pt-20 pb-10 "
      ref={ref}
    >
      <div className="flex  mt-30 md:mt-40  mx-4 w-full justify-center ">
          ...
          {buttons.map((button) => {
            return (
              ...
              >
                ...
                <div className="flex justify-start w-2/3 h-10 mt-2 ">
                  <Button
                    size="lg"
                    className=" w-14"
                    colorScheme="teal"
